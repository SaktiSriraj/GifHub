            ...
            <div className='relative flex gap-4 justify-between items-center mb-2'>
                    ...
                    {categories?.slice(0,5)?.map((category) => {
                        return (
                            <Link 
                                ...
                                className='px-4 py-1  transition ease-in-out hover:gradient border-b-4 hidden lg:block rounded-sm'>
                                    {category.name}
                            </Link>
                        )
                    })}
                ...
                {showCategories && (
                    <div className='absolute right-0 top-14 px-10 pt-6 pb-9 w-full rounded-md gradient z-20'>
                        ...
                        <div className='grid grid-cols-2 ms:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4'>
